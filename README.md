# Contratos — Microservicio de riesgo contratos
...
administra los datos y la lógica del dominio de Contratos del caso caso11 (InmoNube). Su base de datos es una **H2 en memoria** (un solo microservicio por base), cumpliendo aislamiento de datos por dominio.
...
| PUT | `/api/contratos/{id}` | Actualiza un recurso |
| DELETE | `/api/contratos/{id}` | Elimina un recurso |
